// Added by Lawrence, this class used to do some actions like update with style of drop down with listview.
// What's more, you will find a class named DropDownListView is not recommend. It will be a splash screen when you try to scroll down DropDownListView for some devices.
...
package org.lawrence.common.view;
...
public class RefreshableListView extends ListView {
    ...
    private boolean mFreshEnable = true;
    ...
    //Make the refresh feature can work or not 
    // Add by Lawrence
    public void setRefreshable(boolean reFreshable) {
        mFreshEnable = reFreshable;
    }
    ...
    private void setHeaderHeight(final int height) {
        ...
        if (!mIsRefreshing) {
            ...
            if (height > mHeaderHeight && !mArrowUp) {
                ...
                mText.setText(R.string.cm_release_for_update);
                rotateArrow();
                mArrowUp = true;
            } else if (height < mHeaderHeight && mArrowUp) {
                mArrow.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.rotate));
                mText.setText(R.string.cm_down_for_update);
                rotateArrow();
                mArrowUp = false;
            }
        }
    ...
    private void startRefreshing() {
        ...
        mText.setText(R.string.cm_loading);
        mIsRefreshing = true;
